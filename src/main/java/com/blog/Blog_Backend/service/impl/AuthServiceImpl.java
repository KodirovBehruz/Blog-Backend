...
import com.blog.Blog_Backend.entity.Role;
...
import com.blog.Blog_Backend.repository.RoleRepository;
...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    public MeDto getUserById(Long id) {
        User user = userRepository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException("User", "id", id));

        return new MeDto(user.getId(), user.getName(), user.getUsername(), user.getEmail());
    }
}
